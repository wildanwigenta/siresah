...
export default function AdminDashboardPage() {
  ...
  const { complaints, isLoaded, updateComplaint } = useComplaintsStore();
  ...
  const filteredComplaints = complaints.filter(complaint => {
    ...
    if (filters.dateFrom) {
      matchesDateRange = matchesDateRange && new Date(complaint.createdAt) >= new Date(filters.dateFrom);
    }
    if (filters.dateTo) {
      matchesDateRange = matchesDateRange && new Date(complaint.createdAt) <= new Date(filters.dateTo);
    }

    return matchesStatus && matchesCategory && matchesFaculty && matchesPriority && matchesSearch && matchesDateRange;
  });
      ...
      <div className="bg-white shadow-sm">
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
              <Link
                href="/admin/dashboard/statistik"
